\documentclass[12pt]{article}
    \input{zalaczniki/ustawienia/preambula_pakiety.tex}
    \input{zalaczniki/ustawienia/preambula_ustawienia.tex}
    \title{Sprawdzenie możliwości wykorzystania internetu rzeczt (IoT) oraz bezzałogowych statków powietrznych, przy wspomaganiu prowadzenia akcji ratowniczej}
    \author{Piotr Błądek}
    %polecenia zdefiniowane w pakiecie strona_tytulowa.sty
    \uczelnia{POLITECHNIKA WARSZAWSKA}
    \instytut{Wydział Elektryczny \\ Instytut Elektrotechniki Teoretycznej i Systemów Informacyjno-Pomiarowych \\ Zakład Konstrukcji Urządzeń Elektrycznych}
...
\begin{document}
    ...
    \input{zalaczniki/tekstowe/oswiadczenie.tex}
    \newpage
    \input{zalaczniki/tekstowe/streszczeniePL.tex}
    \newpage
    \input{zalaczniki/tekstowe/streszczenieEN.tex}
    \newpage
    ...
    \input{zalaczniki/tekstowe/wykaz_skrotow.tex}
    \newpage
    ...
    %bibliografia
    \input{zalaczniki/tekstowe/bibliografia.tex}                       %polecenie programu WinEdt, włącza plik do drzewa 'projektu'
